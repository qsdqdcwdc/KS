<p align="center">
	<img src="Img/qr_gk_klas2.png" width="250"  title="qr code">
	<br>
...
<details>
  <summary>Klicken für Definition von  rechtsstaatlich, partizipativ, transparent, repressiv, klientelistisch und intransparent</summary>

 **Rechtsstaatlich**: dedeutet, dass Regierung und Verwaltung nur im Rahmen bestehender Gesetze handeln dürfen.

 **Partizipativ**: Bürgerinnen und Bürger können aktiv am politischen Entscheidungsprozess teilnehmen.

**Transparent**: Politische Entscheidungen und Abläufe sind für die Öffentlichkeit nachvollziehbar.

**Repressiv**: Herrschaft erfolgt durch Unterdrückung, Kontrolle und Einsatz von Zwangsmaßnahmen.

**Klientelistisch**: Politische Macht wird durch persönliche Gefälligkeiten, Abhängigkeiten oder Netzwerke gesichert.
...
- **Gewaltenteilung**: Die Aufteilung der staatlichen Macht auf verschiedene unabhängige Organe (Legislative, Exekutive, Judikative).
- **Rechtsstaatlichkeit**: dedeutet, dass Regierung und Verwaltung nur im Rahmen bestehender Gesetze handeln dürfen.
- **Freie und faire Wahlen**: Wahlen, bei denen alle wahlberechtigten Bürger ohne Zwang oder Manipulation abstimmen können.
- **Pluralismus**: beschreibt die Existenz vielfältiger politischer, gesellschaftlicher und kultureller Gruppen, die miteinander konkurrieren. Das Mehrparteiensystem ermöglicht echten politischen Wettbewerb und Auswahlmöglichkeiten für die Bürger.
...
|  Staatsoberhaupt/Regierungschef Rolle        | Geteilt: Kanzler führt die Regierung, Bundespräsident ist vor allem repräsentatives Staatsoberhaupt mit begrenzten politischen Befugnissen            | Geschlossen: Präsident vereint Regierungs- und Staatsoberhauptfunktion in einer Person und leitet allein die Exekutive                 |
...
| **Herrschafts­anspruch** | Eng begrenzt, Regierung kontrolliert, gesetzehaltung, verwaltet staatliche Institutionen(Gesundheitsversorgung, Bildung) und außenpolitischer Aufgaben (diplomatische Beziehungen zu anderen Ländern) | Regime kontrolliert Politik, toleriert weitgehend Privatleben; Eingriffe bei Bedrohung der Stabilität | Unbegrenzt; politisches, soziales und privates Leben sollen ideologisch durchdrungen werden |
...
- **Personalistische Diktatur:** Macht liegt fast ausschließlich in den Händen eines einzelnen Führers; Institutionen dienen primär seiner persönlichen Herrschaft. *Beispiel:*  Nazi-Deutschland (1933 – 1945).
...
- **Überwachungsstaat** bezeichnet einen Staat, der seine Bevölkerung systematische und großflächige Überwachung (z. B. Kameras, Telefon- / Internet-Monitoring, KI-gestützter Gesichtserkennung) kontrolliert; die Überwachung wird dabei zu einem zentralen Herrschaftsinstrument und gefährdet Privatsphäre wie Bürgerrechte. *Beispiele:* Chinas Programm „Sharp Eyes“.
...
### Rechtsstaatsprinzip
Das Rechtsstaatsprinzip bedeutet, dass die Staatsgewalt an Gesetz und Verfassung gebunden ist und die Gewaltenteilung umgesetzt wird – beispielsweise durch die gerichtliche Prüfung legislativer und exekutiver Entscheidungen hinsichtlich ihrer Vereinbarkeit mit der Verfassung. Zudem beinhaltet es die Gewährleistung persönlicher Grundrechte. (Art. 20 GG)
...
Interpretation: Vorhandene Wissen zur Thema wiedergeben.

### Nennen (Anforderungsbereich I/ Reproduktion)
**Beschreibung aus Bildungsplan**: Sachverhalte in knapper Form anführen

Interpretation: Vorhandene Wissen zur Thema kurz wiedergeben.
...
Interpretation: Den zentralen Thema benennen. Fakten und Beispiele anführen, um das Thema zu veranschaulichen/(verständlicher zu machen).
...
Interpretation: Den zu erklärenden Thema benennen, definieren und falls möglich in einen übergeordneten Kontext einordnen (z.B. Theorie, Modell, Regel). Zusammenhänge zu bestehendem Wissen herstellen: Theoriebezug, Modelle, Gesetze oder Regeln als Erklärungsrahmen nutzen. Ursache, Wirkung und Entwicklungsprozess von dem Thema nennen.  
...
Interpretation: Falls nicht angegeben passende Urteilskriterien auswählen. Gemeinsamkeiten und Unterschiede von vorgegebenen Optionen anhand von Urteilskriterien beschreiben. Gewicht/Relevanz/Bedeutung der Gemeinsamkeiten und Unterschiede in jedem Kriterium bewerten. Anhang von früherer Argumentation eine allgemeinen Vergleich der beiden Optionen machen.  Falls möglich eine Entscheidung treffen welche Option die relevante Kriterien besser erfüllt. Anhang von früherer Argumentation ein Fazit ziehen.
