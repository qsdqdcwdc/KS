...
1. <code>Dieses Dokument kann Fehler, Unvollständigkeiten oder Auslassungen enthalten. Ich übernehme keine Gewähr dafür, dass es alle für die Klausur relevanten Themen abdeckt. </code>
...
### Bundesstaatsprinzip
Jedem Bundesland kommt der bei Staatzqualität zu: die Länder haben eigene institutionen (zb Verfassung, Parlament, Regierung und Verwaltung) und eigene zuständigkeiten (zb die Bildung und Polizei). Länder wirken über den Bundesrat an Bundesgesetzen mit.
...
### Rechtsstaatsprinzip
Das Rechtsstaatsprinzip bedeutet, dass die Staatsgewalt an Gesetz und Recht gebunden ist und die Gewaltenteilung umgesetzt wird – beispielsweise durch die gerichtliche Prüfung legislativer und exekutiver Entscheidungen auf ihre Rechtmäßigkeit. Zudem beinhaltet es die Gewährleistung persönlicher Grundrechte. (Art. 20 GG)
